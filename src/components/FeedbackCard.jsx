...
function FeedbackCard() {
  return (
    <div className='flex flex-col gap-8 px-7 lg:px-20 py-14 border border-white/5'>
       ...
       <div className="flex p-2 md:p-4 items-center gap-2 rounded-lg border border-[#262626] bg-[rgba(140,136,136,0.06)] justify-between">
          <div className='flex gap-3 items-center'>
            <div className='w-[25px] h-[25px] md:w-[50px] md:h-[50px] rounded-lg bg-green-500/20'>
          ...
          <button className='hidden md:block px-[14px] py-[16px] text-white rounded-lg bg-[#262626]'>Open Website</button>
       </div>  
    </div>
  )
}
