          ...
          <div className='absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] flex flex-col gap-[50px] justify-center items-center'>
              ...
              <div className="border border-gray-700 bg-[#262626]/20 backdrop-blur rounded-md">
                 <p className='flex items-center gap-1 px-[40px] py-[24px] text-gray-500'>
                   For <span className='px-[14px] py-[12px] bg-gray-700/30 text-white rounded-lg'>Startups</span> , <span className='px-[14px] py-[12px] bg-gray-700/30  text-white rounded-lg'>Enterprise leaders</span>, <span className='px-[14px] py-[12px] bg-gray-700/30  text-white rounded-lg'>Media Publishers</span> and <span className='px-[14px] py-[12px] bg-gray-700/30  text-white rounded-lg'>Social Good</span>
                 </p>
              </div>
